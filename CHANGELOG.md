...
### Changed
- Update demo tour link in README.md

## [5.3.10] - 2026-03-23

### Added
- Enable clean portal tour URL public access without session cookie

## [5.3.9] - 2026-03-22

### Changed
- Maintenance batch, dead dependency cleanup, and immutable state updates

## [5.3.8] - 2026-03-22

### Changed
- Checkpoint before starting pending UI/Cleanup tasks
...
- Checkpoint before portal_audit flow cleanup
...
- V5.3.6+27 [FAST]: checkpoint before classifying portal assets
- V5.3.6+28 [FAST]: classify portal assets in map and flows
- V5.3.6+29 [FAST]: checkpoint before portal package split
- V5.3.6+30 [FAST]: split portal package helpers
- V5.3.6+31 [FAST]: checkpoint before portal session split
- V5.3.6+32 [FAST]: split portal session helpers
...
- Checkpoint before portal views classification
- Classify portal views module
...
- Checkpoint before services backend slice
...
### Changed
- Checkpoint before export formula refinement
- Export Stable: Formula Default Web Package
...
### Fixed
- Tablet landscape joystick positioning above logo

- Joystick now stacks above logo with proper spacing
- Uses: logo_bottom + logo_height + orb_size + gap + safe_area
- Prevents overlap between joystick and watermark logo
...
### Fixed
- Tablet landscape joystick buttons now visible + T1878 rewrite

- Tablet landscape: Joystick up/down buttons now appear above logo (TourStyles.res)
- T1878: Rewritten with simplified approach (extend assignments table, no migration)
- T1877: Moved to completed (HTTPS, CORS, cookies fixed)
- T1881: Created (VPS security hardening - deferred)
- Backend: SameSite=None for mobile cookie compatibility
- Frontend: credentials:include for customer API requests
- GeoIP: MaxMind integration (disabled by default)
- Build: Incremental compilation fixed (no backend/target deletion)
...
### Changed
- Test: align deferred stable regression coverage
...
- Checkpoint export shortcut parity and portrait logo tuning before default animation gating
- Refine exported shortcut progression and manual arrival focus

## [5.2.4] - 2026-03-10

### Changed
- Test: align export regression coverage and refresh analyzer outputs
...
- V5.2.3+23 [FAST]: fix export revisit smart-pan context
...
- Marketing pages responsive + builder-brand parity
...
### Changed
- Checkpoint before project load UX lock implementation
- Stable Version pre test unit adaptation
...
### Fixed
- Finalize visual pipeline branch geometry and commit script dev-task exclusions

## [5.2.1] - 2026-03-03

### Fixed
- Stabilize visual pipeline fork routing and floor continuity

## [5.2.0] - 2026-03-03

### Changed
- Simulation rock solid working
- T1792: Harden unit regression coverage for simulation and navigation

## [5.1.1] - 2026-03-03

### Changed
- T1790: Fix tour preview simulation reliability - advances past scene 1 reliably
...
- V5.2.0 [RELEASE]: High-Performance Image Pipeline & Direct Link Retargeting - Multi-core OffscreenCanvas, WebP 80% standard, real-time ETA, and background auto-titling.
- Stable, working + appropriate commit
...
### Fixed
- Navigation operation lifecycle leaks in SceneTransition and NavigationController

## [5.0.0] - 2026-02-28

### Fixed
- Stabilize post-teaser pipeline connector recovery
...
### Fixed
- Disable builder auto-forward in editing mode
...
- Defer ExifParser runtime via lazy facade to remove exifreader from initial bundle
