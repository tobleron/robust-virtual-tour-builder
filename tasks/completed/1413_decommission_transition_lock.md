...
## Requirements
- [x] Verify zero occurrences of `TransitionLock` in `src/`.
- [x] Delete `src/core/TransitionLock.res`.
- [x] Delete any associated tests (e.g., `tests/unit/TransitionLock_test.res` or similar).
- [x] Clean up any remaining references in `MAP.md` or `DATA_FLOW.md`.

## Acceptance Criteria
- [x] File `src/core/TransitionLock.res` is removed.
- [x] Project builds successfully without warnings.
- [x] `npm test` passes for all remaining modules.
