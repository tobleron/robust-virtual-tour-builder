# Task 1091: Surgical Refactor SYSTEMS FRONTEND
...
- [ ] **../../src/systems/Resizer.res**
    - **Metric:** [Nesting: 1.50, Density: 0.26, Deps: 0.11] | Drag: 8.10 | LOC: 303/89  Hotspot: Lines 218-222
...
- [ ] **../../src/systems/ViewerSystem.res**
    - **Metric:** [Nesting: 1.20, Density: 0.21, Deps: 0.05] | Drag: 6.87 | LOC: 299/105  Hotspot: Lines 207-211
    - **Directive:** Decompose & Flatten: Use guard clauses to reduce nesting and extract dense logic into private helper functions.
...
- [ ] **../../src/systems/PanoramaClusterer.res**
    - **Metric:** [Nesting: 1.20, Density: 0.29, Deps: 0.10] | Drag: 10.15 | LOC: 143/80  Hotspot: Lines 132-136
    - **Directive:** Decompose & Flatten: Use guard clauses to reduce nesting and extract dense logic into private helper functions.
...
- [ ] **../../src/systems/Teaser.res**
    - **Metric:** [Nesting: 1.20, Density: 0.01, Deps: 0.03] | Drag: 2.53 | LOC: 581/224  Hotspot: Lines 594-598
    - **Directive:** Decompose & Flatten: Use guard clauses to reduce nesting and extract dense logic into private helper functions.
