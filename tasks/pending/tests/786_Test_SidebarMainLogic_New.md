# Task 786: Add Unit Tests for SidebarMainLogic.res

## 🚨 Trigger
Modifications detected in `src/components/Sidebar/SidebarMainLogic.res` without established unit tests.

## Objective
Create a Vitest file `tests/unit/SidebarMainLogic_v.test.res` to cover logic in this module.
