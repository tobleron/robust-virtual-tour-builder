# Task 966: Add Unit Tests for ViewerManagerLogic.res

## 🚨 Trigger
Modifications detected in `src/components/ViewerManagerLogic.res` without established unit tests.

## Objective
Create a Vitest file `tests/unit/ViewerManagerLogic_v.test.res` to cover logic in this module.
