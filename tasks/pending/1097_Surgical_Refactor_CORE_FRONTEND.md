# Task 1097: Surgical Refactor CORE FRONTEND
...
- [ ] **../../src/core/Actions.res**
    - **Metric:** [Nesting: 1.05, Density: 0.81, Deps: 0.01] | Drag: 24.35 | LOC: 155/80  Hotspot: Lines 155-159
    - **Directive:** Decompose & Flatten: Use guard clauses to reduce nesting and extract dense logic into private helper functions.
- [ ] **../../src/core/Schemas.res**
    - **Metric:** [Nesting: 0.90, Density: 0.25, Deps: 0.02] | Drag: 6.78 | LOC: 373/108  Hotspot: Lines 390-394
    - **Directive:** Decompose & Flatten: Use guard clauses to reduce nesting and extract dense logic into private helper functions.
