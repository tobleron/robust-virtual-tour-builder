...
- [ ] - **../../src/components/VisualPipeline.res** (Metric: [Nesting: 3.00, Density: 0.09, Coupling: 0.08] | Drag: 4.09 | LOC: 414/300  🎯 Target: Function: `isAutoForward` (High Local Complexity (8.0). Logic heavy.)) → 🏗️ Split into 2 modules (target ~300 LOC each)
