...
- [ ] - **../../src/systems/TourTemplates/TourScripts.res** (Metric: [Nesting: 0.00, Density: 0.01, Coupling: 0.00] | Drag: 1.01 | LOC: 936/409) → 🏗️ Split into 3 modules (target ~300 LOC each)
...
- `src/systems/TourTemplates/TourScripts.res` (3 functions, fingerprint 24000339bdfe7cced029d1300d76747ddb9243a61d1b6d4e720da0de00542e5a)
    - Grouped summary:
        - generateRenderScript × 1 (lines: 967)
        - loadEventScript × 1 (lines: 948)
