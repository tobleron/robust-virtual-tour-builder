...
- `src/systems/OperationLifecycle.res` (30 functions, fingerprint 880f85b7aa4348a6bf7de207fbf48640013017efa496058736f409353bb93dbe)
    - Grouped summary:
        ...
        - complete × 1 (lines: 279)
        - completedTotal × 1 (lines: 15)
        - ensureSweepInterval × 1 (lines: 102)
        - fail × 1 (lines: 322)
        - getOperation × 1 (lines: 145)
        - getOperations × 1 (lines: 149)
        - getStats × 1 (lines: 428)
        - isActive × 1 (lines: 153)
        - isBusy × 1 (lines: 164)
        - leakedTotal × 1 (lines: 16)
        - listeners × 1 (lines: 13)
        - notifyListeners × 1 (lines: 35)
        - operations × 1 (lines: 12)
        - progress × 1 (lines: 244)
        - registerCancel × 1 (lines: 141)
        - reset × 1 (lines: 113)
        - start × 1 (lines: 182)
        - subscribe × 1 (lines: 131)
        ...
        - useIsBusy × 1 (lines: 451)
        - useOperations × 1 (lines: 438)
