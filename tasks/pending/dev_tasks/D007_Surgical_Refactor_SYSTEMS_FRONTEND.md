...
- `src/systems/OperationLifecycle.res` (30 functions, fingerprint 880f85b7aa4348a6bf7de207fbf48640013017efa496058736f409353bb93dbe)
    - Grouped summary:
        ...
        - complete × 1 (lines: 274)
        - completedTotal × 1 (lines: 15)
        - ensureSweepInterval × 1 (lines: 99)
        - fail × 1 (lines: 317)
        - getOperation × 1 (lines: 140)
        - getOperations × 1 (lines: 144)
        - getStats × 1 (lines: 423)
        - isActive × 1 (lines: 148)
        - isBusy × 1 (lines: 159)
        - leakedTotal × 1 (lines: 16)
        - listeners × 1 (lines: 13)
        - notifyListeners × 1 (lines: 35)
        - operations × 1 (lines: 12)
        - progress × 1 (lines: 239)
        - registerCancel × 1 (lines: 136)
        - reset × 1 (lines: 110)
        - start × 1 (lines: 177)
        - subscribe × 1 (lines: 126)
        ...
        - useIsBusy × 1 (lines: 446)
        - useOperations × 1 (lines: 433)
