...
- [ ] - **../../src/components/Sidebar/SidebarLogicHandler.res** (Metric: [Nesting: 4.80, Density: 0.15, Coupling: 0.04] | Drag: 6.06 | LOC: 1026/300  🎯 Target: Function: `parseExportMetrics` (High Local Complexity (16.5). Logic heavy.)) → 🏗️ Split into 4 modules (target ~300 LOC each)
...
- `src/components/Sidebar/SidebarLogicHandler.res` (13 functions, fingerprint 735dad7fd2cf7ec2bc53d5c218af7eeb324908ad4e072ee52b55e82799e6dced)
    - Grouped summary:
        ...
        - handleClearLinksWithUndo × 1 (lines: 737)
        - handleDeleteScene × 1 (lines: 602)
        - handleDeleteSceneWithUndo × 1 (lines: 666)
        - handleExport × 1 (lines: 808)
