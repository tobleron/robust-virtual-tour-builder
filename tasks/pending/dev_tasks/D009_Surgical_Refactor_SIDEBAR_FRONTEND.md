...
- [ ] - **../../src/components/Sidebar/SidebarLogic.res** (Metric: [Nesting: 4.20, Density: 0.10, Coupling: 0.09] | Drag: 5.32 | LOC: 380/300  🎯 Target: Function: `msg` (High Local Complexity (2.0). Logic heavy.)) → 🏗️ Split into 2 modules (target ~300 LOC each)
...
- `src/components/Sidebar/SidebarLogic.res` (8 functions, fingerprint 1e010ccb9a80ad92e78d4cff5e4459e29a646bd574a07cbb55f24bc3cb9c1232)
    - Grouped summary:
        - getProjectData × 1 (lines: 278)
        - handleDeleteScene × 1 (lines: 282)
        - handleExport × 1 (lines: 294)
        - handleLoadProject × 1 (lines: 169)
