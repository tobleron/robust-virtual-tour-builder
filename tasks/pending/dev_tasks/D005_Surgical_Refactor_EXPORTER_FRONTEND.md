...
- [ ] - **../../src/systems/Exporter/ExporterPackaging.res** (Metric: [Nesting: 3.00, Density: 0.06, Coupling: 0.07] | Drag: 4.08 | LOC: 423/300  🎯 Target: Function: `isAborted` (High Local Complexity (2.0). Logic heavy.)) → 🏗️ Split into 2 modules (target ~300 LOC each)
...
- `src/systems/Exporter/ExporterPackaging.res` (7 functions, fingerprint 4f44a920cf00f622874be823daf3a8d637e1983e4217b17e2b68f5fedb176dee)
    - Grouped summary:
        - appendLibraries × 1 (lines: 311)
        - appendLogo × 1 (lines: 60)
        - appendScenes × 1 (lines: 357)
        - appendTemplates × 1 (lines: 198)
        - normalizeMarketingValue × 1 (lines: 13)
        - optimizeBlobAsWebp × 1 (lines: 26)
        - toWebpFilename × 1 (lines: 16)
