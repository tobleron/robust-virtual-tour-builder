...
- [ ] - **../../src/systems/Exporter.res** (Metric: [Nesting: 2.40, Density: 0.04, Coupling: 0.09] | Drag: 3.46 | LOC: 417/300) → 🏗️ Split into 2 modules (target ~300 LOC each)
...
- `src/systems/Exporter.res` (7 functions, fingerprint 0ab80b65d78cf5a8d7b51ae65ec60c8308921c080f789426efa58fe5ed1b611b)
    - Grouped summary:
        ...
        - finalMsg × 1 (lines: 424)
        - msg × 1 (lines: 411)
        - normalizedStack × 1 (lines: 412)
        - payload × 1 (lines: 423)
        - progress × 1 (lines: 16)
        - tourName × 1 (lines: 23)
