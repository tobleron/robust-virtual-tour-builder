...
- [ ] - **../../src/systems/TourTemplates.res** (Metric: [Nesting: 3.60, Density: 0.12, Coupling: 0.03] | Drag: 4.72 | LOC: 886/300  🎯 Target: Function: `extractScenePrefix` (High Local Complexity (3.0). Logic heavy.))
...
- `src/systems/TourTemplates.res` (4 functions, fingerprint 304350c5fd614be01d30b964ec8fd71537a12de284d7a372709b85f9db712f9c)
    - Grouped summary:
        - generateEmbedCodes × 1 (lines: 921)
        - generateExportIndex × 2 (lines: 41, 922)
