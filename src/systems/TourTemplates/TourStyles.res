let cssTemplate = `
    ...
    body.export-ui-landscape-touch-compact #viewer-floor-nav-export .floor-nav-btn.state-idle { background: rgba(255, 255, 255, 0.08); border: 1px solid rgba(255, 255, 255, 0.35); }
    body.export-ui-landscape-touch-compact #viewer-floor-nav-export .floor-nav-btn.state-active { background: #ea580c; border: 2px solid #fdba74; }
    ...
    body.export-ui-landscape-touch-compact #viewer-portrait-joystick-export .portrait-joystick-btn.state-disabled { opacity: 0.34; cursor: default; }
    body.export-ui-landscape-touch-compact #viewer-portrait-joystick-export .portrait-joystick-btn.state-active { background: #ea580c; border-color: #fdba74; box-shadow: none; }
