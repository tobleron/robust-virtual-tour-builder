let cssTemplate = `
    :root { --viewer-bg: #1e1e1e; --stage-border: #333; --glow-color: #fff4d1; --font-family: 'Outfit', sans-serif; --gold-1: #ea580c; --gold-2: #f97316; --gold-3: #c2410c; --gold-text: #ffffff; --gold-border: #7c2d12; --arrow-white: rgba(255, 255, 255, 0.4); --texture-noise: url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.65' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)'/%3E%3C/svg%3E"); --export-control-active-bg: #ea580c; --export-control-active-border: #fdba74; --export-control-classic-idle-bg: rgba(128, 128, 128, 0.22); --export-control-classic-idle-border: rgba(255, 255, 255, 0.28); --export-control-touch-idle-bg: rgba(255, 255, 255, 0.08); --export-control-touch-idle-border: rgba(255, 255, 255, 0.35); --export-control-touch-disabled-opacity: 0.34; --export-fallback-padding: 5px; --export-touch-orb-size: 48px; --export-touch-orb-icon-size: 13px; --export-touch-orb-font-primary: 10px; --export-touch-orb-font-secondary: 9px; --export-touch-orb-gap: 8px; --export-touch-orb-intro-gap: 14px; --export-touch-orb-collapsed-gap: 10px; --export-touch-mode-title-size: 22px; --export-touch-floor-btn-size: 34px; --export-touch-floor-btn-font-size: 13px; --export-touch-floor-btn-sup-size: 7px; --export-touch-rail-left: 13px; --export-touch-docked-top: 12px; --export-touch-docked-orb-left: 6px; --export-touch-floor-bottom: 20px; --export-compact-touch-orb-size: 38px; --export-compact-touch-orb-icon-size: 11px; --export-compact-touch-orb-font-primary: 9px; --export-compact-touch-orb-font-secondary: 8px; --export-compact-touch-orb-gap: 5px; --export-compact-touch-orb-intro-gap: 10px; --export-compact-touch-orb-collapsed-gap: 7px; --export-compact-touch-mode-title-size: 17px; --export-compact-touch-floor-btn-size: 28px; --export-compact-touch-floor-btn-font-size: 11px; --export-compact-touch-floor-btn-sup-size: 6px; --export-compact-touch-rail-left: 9px; --export-compact-touch-docked-top: 9px; --export-compact-touch-docked-orb-left: 5px; --export-compact-touch-floor-bottom: 14px; --export-compact-logo-bottom: 10px; --export-compact-banner-min-height: 22px; --export-compact-banner-font-size: 10px; --export-safe-area-bottom: env(safe-area-inset-bottom, 0px); }
    ...
    body.export-ui-landscape-touch-compact .watermark { bottom: calc(var(--export-compact-logo-bottom) + var(--export-safe-area-bottom)); right: var(--export-compact-touch-rail-left); }
    body.export-ui-landscape-touch-compact .watermark img { max-height: calc(var(--export-logo-height, __LOGO_SIZE__px) * 0.85); }
    ...
    body.export-ui-landscape-touch-compact #viewer-marketing-banner-export { min-height: var(--export-compact-banner-min-height); max-width: min(88%, 620px); bottom: var(--export-safe-area-bottom); }
    body.export-ui-landscape-touch-compact .viewer-marketing-chip-export { font-size: var(--export-compact-banner-font-size); padding: 3px 7px 2px 7px; }
    body.export-ui-landscape-touch-compact .viewer-marketing-text-wrap-export { padding: 3px 11px 2px 11px; border-top-right-radius: 6px; }
    body.export-ui-landscape-touch-compact .viewer-marketing-chip-left-export { border-top-left-radius: 6px; }
    body.export-ui-landscape-touch-compact .viewer-marketing-text-wrap-export-left { border-top-left-radius: 6px; }
    body.export-ui-landscape-touch-compact .viewer-marketing-text-wrap-export::after { bottom: -2px; height: 5px; }
    body.export-ui-landscape-touch-compact .viewer-marketing-banner-text-export { font-size: clamp(7.5px, 0.9vw, var(--export-compact-banner-font-size)); }
    ...
    #viewer-floor-nav-export .floor-nav-btn.state-active { border: 2px solid var(--export-control-active-bg); background: var(--export-control-active-bg); color: #fff; }
    #viewer-floor-nav-export .floor-nav-btn.state-idle { border: 1px solid var(--export-control-classic-idle-border); background: var(--export-control-classic-idle-bg); color: #fff; }
    ...
    body.export-ui-landscape-touch-compact .viewer-persistent-label-export { top: 14px; height: 20px; font-size: 9px; padding: 0 0.35rem 0 0; border-radius: 5px; letter-spacing: 0.08em; }
    body.export-ui-landscape-touch-compact .viewer-persistent-label-export-seq { min-width: 26px; padding: 0 0.28rem; margin-right: 0.32rem; border-radius: 5px 0 0 5px; font-size: 8.5px; }
    body.export-ui-landscape-touch-compact .viewer-persistent-label-export-name { padding-right: 0.08rem; letter-spacing: 0.06em; }
    ...
    body.export-ui-portrait-adaptive #viewer-floor-nav-export .floor-nav-btn.state-idle { background: var(--export-control-touch-idle-bg); border: 1px solid var(--export-control-touch-idle-border); }
    body.export-ui-portrait-adaptive #viewer-floor-nav-export .floor-nav-btn.state-active { background: var(--export-control-active-bg); border: 2px solid var(--export-control-active-border); }
    ...
    body.export-ui-landscape-touch #viewer-floor-nav-export .floor-nav-btn.state-idle { background: var(--export-control-touch-idle-bg); border: 1px solid var(--export-control-touch-idle-border); }
    body.export-ui-landscape-touch #viewer-floor-nav-export .floor-nav-btn.state-active { background: var(--export-control-active-bg); border: 2px solid var(--export-control-active-border); }
    body.export-ui-landscape-touch-compact #viewer-floor-nav-export { gap: var(--export-compact-touch-orb-gap); bottom: calc(var(--export-compact-touch-floor-bottom) + var(--export-safe-area-bottom)); left: var(--export-compact-touch-rail-left); z-index: 6006; transition: opacity 0.24s ease, transform 0.24s ease; }
    body.export-ui-landscape-touch-compact #viewer-floor-nav-export .floor-nav-btn { cursor: pointer; color: #fff; backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); width: var(--export-compact-touch-floor-btn-size); height: var(--export-compact-touch-floor-btn-size); min-width: var(--export-compact-touch-floor-btn-size); min-height: var(--export-compact-touch-floor-btn-size); font-size: var(--export-compact-touch-floor-btn-font-size); box-shadow: 0 6px 12px rgba(0,0,0,0.15); }
    body.export-ui-landscape-touch-compact #viewer-floor-nav-export .floor-nav-btn sup { font-size: var(--export-compact-touch-floor-btn-sup-size); margin-left: 0; }
    body.export-ui-landscape-touch-compact #viewer-floor-nav-export .floor-nav-btn.state-idle { background: var(--export-control-touch-idle-bg); border: 1px solid var(--export-control-touch-idle-border); }
    body.export-ui-landscape-touch-compact #viewer-floor-nav-export .floor-nav-btn.state-active { background: var(--export-control-active-bg); border: 2px solid var(--export-control-active-border); }
    ...
    body.export-ui-landscape-touch-compact .export-hotspot-root { width: 24px; height: 24px; }
    body.export-ui-landscape-touch-compact .export-hotspot-icon { width: 14px; height: 14px; }
    body.export-ui-landscape-touch-compact .export-hotspot-face-text { font-size: 11px; }
    body.export-ui-landscape-touch-compact .export-hotspot-label { font-size: 11px; top: -24px; }
    ...
    body.export-ui-landscape-touch-compact:not(.is-map-open) .looking-mode-indicator { background: transparent !important; border: none !important; box-shadow: none !important; box-sizing: border-box; justify-content: flex-start; align-items: flex-start; min-width: auto; max-width: none; padding: 0 !important; top: 10px; left: var(--export-compact-touch-rail-left); }
    body.export-ui-landscape-touch-compact .mode-status-line { display: none !important; }
    ...
    body.export-ui-portrait-adaptive #viewer-portrait-joystick-export .portrait-joystick-btn.state-disabled { opacity: var(--export-control-touch-disabled-opacity); cursor: default; }
    body.export-ui-portrait-adaptive #viewer-portrait-joystick-export .portrait-joystick-btn.state-active { background: var(--export-control-active-bg); border-color: var(--export-control-active-border); box-shadow: none; }
    ...
    body.export-ui-landscape-touch #viewer-portrait-joystick-export { pointer-events: none; position: absolute; right: var(--export-touch-rail-left); bottom: calc(var(--export-compact-logo-bottom) + var(--export-logo-height, __LOGO_SIZE__px) + var(--export-touch-orb-size) + var(--export-touch-orb-gap) + var(--export-safe-area-bottom)); transform: none; z-index: 6006; display: flex; flex-direction: column; align-items: center; gap: var(--export-touch-orb-gap); }
    body.export-ui-landscape-touch #viewer-portrait-joystick-export .portrait-joystick-btn { color: #fff; text-shadow: 1.5px 1.5px 0px rgba(0,0,0,0.95), 0px 0px 4px rgba(0,0,0,0.25); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); pointer-events: auto; cursor: pointer; background: rgba(255, 255, 255, 0.07); border: 1px solid rgba(255, 255, 255, 0.32); border-radius: 9999px; justify-content: center; align-items: center; width: var(--export-touch-orb-size); height: var(--export-touch-orb-size); padding: 0; transition: transform 0.2s ease, background 0.2s ease, border-color 0.2s ease, opacity 0.2s ease; display: flex; box-shadow: none; }
    body.export-ui-landscape-touch #viewer-portrait-joystick-export .portrait-joystick-btn.state-disabled { opacity: var(--export-control-touch-disabled-opacity); cursor: default; }
    body.export-ui-landscape-touch #viewer-portrait-joystick-export .portrait-joystick-btn.state-active { background: var(--export-control-active-bg); border-color: var(--export-control-active-border); box-shadow: none; }
    ...
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector { position: absolute; top: var(--export-compact-touch-docked-top); left: var(--export-compact-touch-docked-orb-left); margin: 0; padding: 0; border-top: none; width: auto; min-width: 0; z-index: 7002; }
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector.state-intro { top: 50%; left: 50%; transform: translate(-50%, -50%) scale(1); }
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector.state-collapsing { top: var(--export-compact-touch-docked-top); left: var(--export-compact-touch-docked-orb-left); transform: translate(0, 0) scale(0.96); }
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector.state-docked { top: var(--export-compact-touch-docked-top); left: var(--export-compact-touch-docked-orb-left); transform: none; }
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector .portrait-mode-selector-cluster { display: inline-flex; align-items: center; justify-content: center; gap: var(--export-compact-touch-orb-intro-gap); }
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector.state-intro .portrait-mode-selector-cluster { flex-direction: row; }
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector.state-collapsing .portrait-mode-selector-cluster,
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector.state-docked .portrait-mode-selector-cluster { flex-direction: row; align-items: center; gap: var(--export-compact-touch-orb-collapsed-gap); }
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector .portrait-mode-selector-title { font-size: var(--export-compact-touch-mode-title-size); }
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector .portrait-mode-orb { color: #fff; text-shadow: 1.5px 1.5px 0px rgba(0,0,0,0.95), 0px 0px 4px rgba(0,0,0,0.25); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); cursor: pointer; background: linear-gradient(180deg, rgba(255, 255, 255, 0.15), rgba(255, 255, 255, 0.07)); border: 1px solid rgba(255, 255, 255, 0.28); border-radius: 9999px; justify-content: center; align-items: center; width: var(--export-compact-touch-orb-size); height: var(--export-compact-touch-orb-size); padding: 0; font-family: var(--font-family); font-size: var(--export-compact-touch-orb-font-primary); font-weight: 800; letter-spacing: 0.03em; line-height: 1; transition: transform 0.2s ease, background 0.2s ease, border-color 0.2s ease, opacity 0.2s ease; display: inline-flex; flex-direction: column; gap: 2px; box-shadow: none; }
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector.state-intro .portrait-mode-orb.state-idle { background: linear-gradient(180deg, #0e2d52, #002147); border-color: rgba(147, 197, 253, 0.38); }
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector .portrait-mode-orb.state-active,
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector .portrait-mode-orb.state-boosted { background: linear-gradient(180deg, #ea580c, #c2410c); border-color: #fdba74; box-shadow: none; }
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector .portrait-mode-orb.state-boosted { background: linear-gradient(180deg, #f97316, #c2410c); }
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector .portrait-mode-orb:disabled { opacity: 0.45; cursor: default; }
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector .portrait-mode-orb-line { display: block; text-align: center; }
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector .portrait-mode-orb-line-primary { font-size: var(--export-compact-touch-orb-font-primary); }
    body.export-ui-landscape-touch-compact #viewer-portrait-mode-selector-export.is-portrait-mode-selector .portrait-mode-orb-line-secondary { font-size: var(--export-compact-touch-orb-font-secondary); opacity: 0.96; }
    body.export-ui-landscape-touch-compact #viewer-portrait-joystick-export { pointer-events: none; position: absolute; right: var(--export-compact-touch-rail-left); bottom: calc(var(--export-compact-logo-bottom) + var(--export-logo-height, calc(__LOGO_SIZE__px)) + var(--export-safe-area-bottom)); transform: none; z-index: 6006; display: flex; flex-direction: column; align-items: center; gap: var(--export-compact-touch-orb-gap); }
    body.export-ui-landscape-touch-compact #viewer-portrait-joystick-export .portrait-joystick-btn { color: #fff; text-shadow: 1.5px 1.5px 0px rgba(0,0,0,0.95), 0px 0px 4px rgba(0,0,0,0.25); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); pointer-events: auto; cursor: pointer; background: rgba(255, 255, 255, 0.07); border: 1px solid rgba(255, 255, 255, 0.32); border-radius: 9999px; justify-content: center; align-items: center; width: var(--export-compact-touch-orb-size); height: var(--export-compact-touch-orb-size); padding: 0; transition: transform 0.2s ease, background 0.2s ease, border-color 0.2s ease, opacity 0.2s ease; display: flex; box-shadow: none; }
    body.export-ui-landscape-touch-compact #viewer-portrait-joystick-export .portrait-joystick-btn.state-disabled { opacity: var(--export-control-touch-disabled-opacity); cursor: default; }
    body.export-ui-landscape-touch-compact #viewer-portrait-joystick-export .portrait-joystick-btn.state-active { background: var(--export-control-active-bg); border-color: var(--export-control-active-border); box-shadow: none; }
    body.export-ui-landscape-touch-compact #viewer-portrait-joystick-export .portrait-joystick-icon { width: var(--export-compact-touch-orb-icon-size); height: var(--export-compact-touch-orb-icon-size); display: block; transform-origin: 50% 50%; }
    body.export-ui-landscape-touch-compact #viewer-portrait-joystick-export .portrait-joystick-icon path { stroke: currentColor; stroke-width: 5px; fill: none; stroke-linecap: round; stroke-linejoin: round; }
    body.export-ui-landscape-touch-compact #viewer-portrait-joystick-export .portrait-joystick-btn.state-up .portrait-joystick-icon { transform: rotate(-90deg); }
    body.export-ui-landscape-touch-compact #viewer-portrait-joystick-export .portrait-joystick-btn.state-down .portrait-joystick-icon { transform: rotate(90deg); }
    ...
    body:not(.export-ui-portrait-adaptive):not(.export-ui-landscape-touch):not(.export-ui-landscape-touch-compact):not(.export-portrait-mode-intro):not(.export-portrait-mode-collapsing) #viewer-portrait-mode-selector-export,
    body:not(.export-ui-portrait-adaptive):not(.export-ui-landscape-touch):not(.export-ui-landscape-touch-compact) #viewer-portrait-joystick-export { display: none !important; }
    ...
    body.export-ui-landscape-touch-compact.is-map-open #viewer-portrait-mode-selector-export { display: none !important; }
    body.export-ui-landscape-touch-compact.is-map-open #viewer-portrait-joystick-export { display: none !important; }
