    ...
    | Some(element) => 
        ...
        Dom.addEventListener(element, "mouseup", e => {
           ...
           | Some((x, y, t)) =>
              ...
              Logger.info(~module_="ViewerSystem", ~message="MOUSE_UP_CHECK_NATIVE", ~data=Some({"diffX": diffX, "diffY": diffY, "diffT": diffT}), ())
              ...
              if diffX < 5.0 && diffY < 5.0 && diffT < 500.0 {
                 ...
                 Logger.info(~module_="ViewerSystem", ~message="CLICK_REJECTED", ~data=Some({"diffX": diffX, "diffY": diffY, "diffT": diffT}), ())
              }
           | None => ()
           }
           lastDown := None
