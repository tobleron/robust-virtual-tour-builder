...
module InternalStyles = {
  ...
  let styles = "
    ...
    .drop-zone::after {
      content: ''; position: absolute; width: " ++ Int.toString(nodeSize) ++ "px;
      height: " ++ Int.toString(nodeSize) ++ "px; border-radius: 50%;
    ...
    .pipeline-node {
      width: " ++ Int.toString(nodeSize) ++ "px; height: " ++ Int.toString(nodeSize) ++ "px;
