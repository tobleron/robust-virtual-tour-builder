...
let make = React.memo(() => {
  ...
  <>
    ...
    <div
      id="viewer-logo"
      className="absolute bottom-6 right-6 z-[5002] flex items-center justify-center max-w-[126px] max-h-[66px] overflow-hidden viewer-logo-masked pointer-events-none p-[1px] rounded-md bg-white/10 backdrop-blur-md border border-orange-500/50 shadow-lg"
    >
      <img
        src=logoSrc
        alt="Logo"
