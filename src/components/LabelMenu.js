...
export function createLabelMenu(viewerStage, labelButton) {
    ...
    style.textContent = `
    #v-scene-label-menu::-webkit-scrollbar { display: none !important; width: 0 !important; }
    #v-scene-label-menu { -ms-overflow-style: none !important; scrollbar-width: none !important; }
  `;
    ...
    `;
        ...
        lblMenu.appendChild(section);
    });

    // Custom Label Section
    const customSection = document.createElement("div");
    customSection.className = "flex flex-col gap-2 pt-1 border-t border-slate-50";
