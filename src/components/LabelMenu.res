        ...
        <Shadcn.DropdownMenu.Group key={category}>
          ...
          ->Belt.Array.map(label => {
            ...
            <Shadcn.DropdownMenu.Item
              ...
              className={`mx-1 my-0.5 px-2 py-1.5 text-[10px] font-bold uppercase tracking-wide cursor-pointer
    ...
    <div className="p-3 bg-slate-50/50" onClick={e => JsxEvent.Mouse.stopPropagation(e)}>
      ...
      <div className="flex gap-1.5">
        <input
          ...
          className="flex-1 min-w-0 bg-white border border-slate-200 rounded-md px-2 py-1.5 text-[11px] font-bold text-slate-700 outline-none focus:border-primary transition-all"
        />
        <button
          onClick={_ => handleApplyCustom()}
          className="px-3 py-1.5 bg-primary text-white rounded-md text-[10px] font-black uppercase tracking-widest hover:bg-primary-light active:scale-95 transition-all shadow-sm"
        >
          {React.string("SET")}
        </button>
      </div>
      <button
        ...
        className="w-full mt-2 py-1.5 bg-white border border-slate-200 text-slate-400 rounded-md text-[9px] font-black uppercase tracking-widest hover:bg-orange-50 hover:text-danger hover:border-danger/30 active:scale-95 transition-all"
      >
