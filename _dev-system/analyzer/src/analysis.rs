...
pub fn infer_taxonomy(path: &Path, content: &str) -> String {
    ...
    if f == "main.rs" || f == "lib.rs" || f == "mod.rs" || f == "main.res" || f == "app.res" || f == "index.js" || p.contains("actions") || p.contains("serviceworker") { 
    ...
    if p.contains("/components/") || p.contains("view") || p.contains("/public/") || ext == "css" || ext == "html" || ext == "jsx" { 
