...
- [ ] **../../src/core/SimHelpers.res**
  - *Reason:* LOC 38 > Limit 30 (Role: domain-logic, Drag: 9.58)
    🔥 Hotspot: Lines 26-30 (AI Context Fog (score 29.0))
- [ ] **../../src/core/ViewerState.res**
  - *Reason:* LOC 91 > Limit 30 (Role: domain-logic, Drag: 43.11)
...
- [ ] **../../src/systems/SvgManager.res**
  - *Reason:* LOC 137 > Limit 30 (Role: service-orchestrator, Drag: 25.46)
...
- [ ] **../../src/systems/ViewerPool.res**
  - *Reason:* LOC 94 > Limit 30 (Role: service-orchestrator, Drag: 17.62)
...
- [ ] **../../src/systems/PannellumAdapter.res**
  - *Reason:* LOC 68 > Limit 30 (Role: service-orchestrator, Drag: 20.88)
...
- [ ] **../../src/systems/SimulationPathGenerator.res**
  - *Reason:* LOC 202 > Limit 30 (Role: service-orchestrator, Drag: 37.93)
