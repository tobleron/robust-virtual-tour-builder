...
## 🛠️ SURGICAL REFACTOR TASKS (16)
- [ ] **../../src/utils/WorkerPool.res**
  - *Reason:* [Nesting: 1.80, Density: 0.09, Coupling: 0.02] | Drag: 3.10 | LOC: 508/300  🎯 Target: Function: `createPoolSize` (High Local Complexity (6.0). Logic heavy.)
- [ ] **../../src/components/PreviewArrow.res**
  - *Reason:* [Nesting: 3.60, Density: 0.12, Coupling: 0.08] | Drag: 4.82 | LOC: 410/300  🎯 Target: Function: `handleMainClick` (High Local Complexity (7.1). Logic heavy.)
- [ ] **../../src/components/VisualPipeline.res**
  - *Reason:* [Nesting: 4.20, Density: 0.09, Coupling: 0.04] | Drag: 5.29 | LOC: 883/300  🎯 Target: Function: `parentByScene` (High Local Complexity (12.4). Logic heavy.)
...
- [ ] **../../src/core/JsonParsersDecoders.res**
  - *Reason:* [Nesting: 3.00, Density: 0.65, Coupling: 0.05] | Drag: 4.65 | LOC: 376/300  🎯 Target: Function: `project` (High Local Complexity (13.4). Logic heavy.)
