...
- [ ] **../../src/systems/ProjectManager.res**
  - *Reason:* [Nesting: 4.20, Density: 0.20, Coupling: 0.10] | Drag: 5.40 | LOC: 403/300  🎯 Target: Function: `finalToken` (High Local Complexity (2.0). Logic heavy.)
- [ ] **../../src/core/SceneMutations.res**
  - *Reason:* [Nesting: 5.40, Density: 0.25, Coupling: 0.05] | Drag: 6.67 | LOC: 405/300  🎯 Target: Function: `getDeletedIds` (High Local Complexity (3.5). Logic heavy.)
...
- [ ] **../../src/systems/UploadProcessorLogic.res**
  - *Reason:* [Nesting: 2.40, Density: 0.04, Coupling: 0.11] | Drag: 3.44 | LOC: 399/300  🎯 Target: Function: `getNotificationType` (High Local Complexity (4.0). Logic heavy.)
