...
mod tests {
    ...
    fn test_sanitize_asset_path_removes_traversal() {
        ...
        assert_eq!(
            sanitize_asset_path("images/../hidden/secret.jpg"),
            "secret.jpg"
        );
        assert_eq!(
            sanitize_asset_path("/absolute/path/to/file.png"),
            "file.png"
        );
    ...
    fn test_normalize_project_entry_path() {
        ...
        assert_eq!(
            normalize_project_entry_path("scene1.webp"),
            Some("images/scene1.webp".to_string())
        );
        assert_eq!(
            normalize_project_entry_path("nested/folder/scene2.jpg"),
            Some("images/scene2.jpg".to_string())
        );
