...
pub async fn init_session(
    ...
    let size_bytes_usize = validate_payload_size(size_bytes, MAX_EXPORT_PAYLOAD_SIZE_BYTES)?;
...
pub async fn save_chunk(
    ...
    let computed_sha = sha256_hex(&chunk_data);
