...
describe("TourTemplateScripts", () => {
  ...
  test("generateRenderScript should embed exported auto-tour speed constants and toggle helpers", t => {
    let script = generateRenderScript(32, 90.0, 65.0, 90.0, 375, 640, true, false)
    ...
    t->expectToContain(script, "speedLabel.textContent = isSpeedBoosted ? \"slow down 1x\" : \"speed up 1.7x\";")
  ...
  test("generateRenderScript should render auto-tour speed toggle above stop action", t => {
    let script = generateRenderScript(32, 90.0, 65.0, 90.0, 375, 640, true, false)
    let speedIndex = String.indexOf(script, "speedLabel.textContent = isSpeedBoosted ? \"slow down 1x\" : \"speed up 1.7x\";")
