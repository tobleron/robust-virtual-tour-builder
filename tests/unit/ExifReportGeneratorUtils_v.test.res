...
describe("ExifReportGeneratorUtils", () => {
  describe("generateProjectName", () => {
    test("generates name from address and date", t => {
    ...
    test("handles unicode characters in address", t => {
    ...
    test("falls back to 'Tour' when address is missing", t => {
    ...
    test("falls back to current time when date is missing or invalid", t => {
  ...
  describe("downloadExifReport", () => {
    test("creates download link and clicks it", t => {
