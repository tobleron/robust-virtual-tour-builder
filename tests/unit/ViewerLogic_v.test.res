...
describe("ViewerLogic", () => {
  describe("getEdgePower", () => {
    ...
    test("returns negative power when below negative deadzone", t => {
      // val = -0.5, dz = 0.0
      // a = 0.5, n = 0.5 / 1.0 = 0.5
      // s = -1.0
      // res = -0.25
    ...
    test("calculates curve correctly", t => {
      // val = 0.8, dz = 0.6
      // a = 0.8
