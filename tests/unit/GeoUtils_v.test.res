...
describe("GeoIP Service", () => {
  describe("GeoIP Disabled by Default", () => {
    test(
      "GeoIP lookup is disabled when GEOIP_ENABLED=false",
      t => {
    ...
    test(
      "GeoIP does not make external API calls when disabled",
      t => {
  ...
  describe("GeoIP Lookup (When Enabled)", () => {
    test(
      "GeoIP returns country code when enabled",
      t => {
        // Mock GeoIP response
    ...
    test(
      "GeoIP handles missing region gracefully",
      t => {
    ...
    test(
      "GeoIP handles API errors gracefully",
      t => {
        // Document error handling
  ...
  describe("GeoIP Data Storage", () => {
    test(
      "GeoIP stores country code on assignment",
      t => {
    ...
    test(
      "GeoIP updates last country on each access",
      t => {
        // Document expected behavior
  ...
  describe("GeoIP Privacy", () => {
    test(
      "GeoIP does not store full IP addresses",
      t => {
    ...
    test(
      "GeoIP uses hashed IP for analytics",
      t => {
    ...
    test(
      "GeoIP data can be cleared on request",
      t => {
